...
public class ConvertFeetToInches {
    public static void main(String[] args) {
        ...
        // feetStr = in.nextLine(); //What happens if a user enters an int, a double, or
        // a String?
        ...
        // convertAnother = in.nextLine(); //What happens if you enter a letter other
        // than Y or N?
        // }//end while
        ...
        if (phoneNum1.compareTo(phoneNum2) > 0) {
            System.out.print(1);
        }
