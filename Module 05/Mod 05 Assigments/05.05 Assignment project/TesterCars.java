public class TesterCars {
    ...
    public static void printCars(String carName, double hPower, String cFactor) {
    ...
    public static void main(String[] args) {
        ...
        double car1HPower = Cars.HorsePower(car1Torque, car1RPM);
        ...
        double car2HPower = Cars.HorsePower(car2Torque, car2RPM);
