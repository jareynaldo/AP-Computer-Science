...
public class MathMethodsDemo {
        public static void main(String[] args) {
                ...
                System.out.println("The square root of " + someNumber + " is: " +
                                squareRoot);
                System.out.println();
                ...
                System.out.println("The absolute value of " + integerNumber + " is: " +
                                intAbsValue);
                System.out.println();
                ...
                System.out.println("The absolute value of " + decimalNumber + " is: " +
                                decimalAbsValue);
                System.out.println();

                // example of using the constant PI to calculate a circumference
                // notice that PI is not assigned a value, it has a constant value assigned by
                // the Math class

                double myRadius = 3.5;
                double myCircumference = 2 * Math.PI * myRadius;
                System.out.println("The circumference of a circle with radius " + myRadius +
                                " is: " + myCircumference);
                System.out.println();
                 ...
                 * System.out.
                 * println("The result of Math.sqrt(Math.pow(Math.abs(x2 - x1),3)) is: " +
                 * answer);
                 * System.out.println();
                 */
        }// end of main method
